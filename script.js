...
const I18N = {
  en: {
    ...
    title_heading:"From the taste of the soil to modern Indian cuisine",
    about_p1: "From the authentic flavors of the soil to modern Indian cuisine—I am Chef Pankaj Prajapati. For me, food is not merely a means to satisfy hunger but a beautiful medium to connect with people. My journey did not begin at a grand hotel or a culinary school; it started at a small shop where I sold handmade samosas, bread, and snacks. Every day, the smiles and appreciation of my customers inspired me to innovate. One day, someone told me, You have a gift; don't limit it to just this shop. Turn it into a profession. That moment was perhaps the biggest turning point of my life. Little did I know then that this simple piece of advice would lead me into the world of the hospitality industry—a realm where flavor, art, and creativity converge. A passion for learning and sheer hard work took me to five-star hotels, luxury catering services, premium clubs, and large-scale professional kitchens. There, I mastered international culinary techniques, yet I never lost sight of my own unique identity.",
    about_p2: "Today, I am primarily known as a Modern Indian Chef. I reimagine India’s traditional and street foods, elevating them with modern presentation, innovative techniques, and exquisite flavors. I believe that iconic treats like *golgappas*, *samosas*, or *chaat*—flavors born in the streets—deserve to be served on fine-dining plates with the same pride and elegance as any international delicacy. To me, every dish tells a story. I want my guests to do more than just eat; I want them to experience a memory, a feeling, and the essence of Indian culture with every single bite. The greatest success in my work is when a guest tells me they have experienced a familiar flavor in a completely new and exciting way. Cooking and traveling are the two most vital parts of my life. Visiting new places, exploring local markets, tasting street food, meeting people, and understanding their culinary traditions constantly teach me something new. Every journey I take becomes the inspiration for my next menu. I believe that a chef does not merely create recipes but crafts experiences. My constant endeavor is to present the authentic flavors and soul of India to the world in a modern avatar. This journey continues; every new trip, every new flavor, and every new plate inspires me to start afresh—because, for me, food is not just a profession; it is my identity, my passion, and my story.",
  ...
  hi: {
    ...
    title_heading:"मिट्टी के स्वाद से मॉडर्न इंडियन क्यूज़ीन तक ",
    about_p1: "मिट्टी के स्वाद से मॉडर्न इंडियन क्यूज़ीन तक मेरा नाम शेफ पंकज प्रजापति है। मेरे लिए खाना सिर्फ़ पेट भरने का ज़रिया नहीं, बल्कि लोगों से जुड़ने का सबसे खूबसूरत माध्यम है। मेरा सफ़र किसी बड़े होटल या क्यूलिनरी स्कूल से शुरू नहीं हुआ। इसकी शुरुआत हुई मेरी छोटी-सी दुकान से, जहाँ मैं अपने हाथों से बने समोसे, ब्रेड और स्नैक्स बेचता था। हर दिन ग्राहकों की मुस्कान और उनकी तारीफ़ मुझे कुछ नया करने की प्रेरणा देती थी। एक दिन किसी ने मुझसे कहा, “तुम्हारे हाथों में हुनर है, इसे सिर्फ़ दुकान तक मत रखो। इसे एक प्रोफेशन बनाओ।” शायद वही पल मेरी ज़िंदगी का सबसे बड़ा मोड़ था। मुझे तब नहीं पता था कि यह छोटी-सी सलाह मुझे होटल इंडस्ट्री की उस दुनिया तक ले जाएगी, जहाँ स्वाद, कला और क्रिएटिविटी एक साथ मिलते हैं। सीखने की चाह और मेहनत ने मुझे पाँच सितारा होटलों, लग्ज़री कैटरिंग, प्रीमियम क्लब्स और बड़े-बड़े किचन्स तक पहुँचाया। वहाँ मैंने इंटरनेशनल तकनीकों को सीखा, लेकिन अपनी पहचान कभी नहीं छोड़ी।",
    about_p2: "आज मेरी सबसे बड़ी पहचान Modern Indian Chef के रूप में है। मैं भारत के पारंपरिक और स्ट्रीट फूड को आधुनिक प्रस्तुति, नई तकनीकों और बेहतरीन फ्लेवर के साथ एक नया रूप देता हूँ। मेरा मानना है कि गोलगप्पा, समोसा, चाट या किसी गली का मशहूर स्वाद भी उतनी ही शान से फाइन डाइनिंग की प्लेट पर परोसा जा सकता है, जितनी किसी इंटरनेशनल डिश की। मेरे लिए हर डिश एक कहानी है। मैं चाहता हूँ कि मेहमान सिर्फ़ खाना न खाएँ, बल्कि हर निवाले के साथ एक याद, एक एहसास और भारत की संस्कृति को महसूस करें। जब कोई मेहमान कहता है कि उसने पहली बार किसी परिचित स्वाद को इतने नए अंदाज़ में चखा है, वही मेरे काम की सबसे बड़ी सफलता होती है। खाना बनाना और सफ़र करना मेरी ज़िंदगी के दो सबसे अहम हिस्से हैं। नई जगहों पर जाना, वहाँ के स्थानीय बाज़ारों में घूमना, स्ट्रीट फूड चखना, लोगों से मिलना और उनकी खाने की परंपराओं को समझना मुझे लगातार कुछ नया सिखाता है। मेरी हर यात्रा मेरे अगले मेन्यू की प्रेरणा बनती है। मैं मानता हूँ कि एक शेफ सिर्फ़ रेसिपी नहीं बनाता, बल्कि अनुभव बनाता है। मेरी कोशिश हमेशा यही रहती है कि भारत के असली स्वाद को उसकी आत्मा के साथ दुनिया के सामने आधुनिक रूप में पेश करूँ। यह सफ़र अभी जारी है। हर नई यात्रा, हर नया स्वाद और हर नई प्लेट मुझे फिर से शुरुआत करने का उत्साह देती है। क्योंकि मेरे लिए खाना सिर्फ़ एक पेशा नहीं, बल्कि मेरी पहचान, मेरा जुनून और मेरी कहानी है।",
